#!/usr/bin/env python3
"""Paper-style horizon benchmark for the conditional-censoring triplet.
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Run the paper-style horizon benchmark for Final Conditional Oracle / "
...
def _resolve_output_dir(args: argparse.Namespace) -> Path:
    ...
    return (PROJECT_ROOT / "outputs" / "paper_style_horizon_conditional_triplet").resolve()
