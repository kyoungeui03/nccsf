...
H_PROFILES = [
    ...
    ("h=extra800x5", {"h_kind": "extra", "h_n_estimators": 800, "h_min_samples_leaf": 5}),
    ...
    for feature_mode in FINAL_FEATURE_MODES:
        for q_label, q_kwargs in Q_PROFILES:
            for h_label, h_kwargs in H_PROFILES:
                ...
                name = f"SPGridNC[{feature_mode}|{q_label}|{h_label}]"
...
def parse_args():
    parser = argparse.ArgumentParser(description="Run basic12 non-censored single-pass search.")
