...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Run the finalized 8-variant benchmark across the 12 standardized synthetic cases."
    )
    parser.add_argument(
        "--output-dir",
        type=Path,
...
def main() -> int:
    ...
    audit = {
        "benchmark_definition": {
            ...
            "C3": "NC X+W+Z final forest, all estimated with econml mild shrink",
        },
        "metrics": [
            "Pred CATE",
            "True CATE",
