...
MODEL_SPECS = [
    (
        "B2Sum Swap Cens (BaselineDML + no outer residuals)",
        B2SummaryBaselineDMLCensoredSurvivalForest,
    ),
    (
        "BroadAugSP (SurvPair & NA)",
        BroadAugSPCensoredSurvivalForest,
    ),
]
...
def parse_args():
    parser = argparse.ArgumentParser(description="Run basic12 censored B2Sum-swap vs BroadAugSP.")
