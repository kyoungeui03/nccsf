...
MODEL_SPECS = [
    {
        "name": "BroadAugSP (SurvPair & NA)",
        "kind": "python",
        "cls": BroadAugSPCensoredSurvivalForest,
        "surv_scalar_mode": "pair",
        "censoring_estimator": "nelson-aalen",
    },
    {
        "name": "BroadAugSP (SurvPair & KM)",
        "kind": "python",
        "cls": BroadAugSPCensoredSurvivalForest,
        "surv_scalar_mode": "pair",
    ...
    {
        "name": "B2Sum (SurvPair & NA)",
        "kind": "python",
        "cls": B2SummaryCensoredSurvivalForest,
        "surv_scalar_mode": "pair",
        "censoring_estimator": "nelson-aalen",
    },
    {
        "name": "B2Sum (SurvPair & KM)",
        "kind": "python",
        "cls": B2SummaryCensoredSurvivalForest,
        "surv_scalar_mode": "pair",
        "censoring_estimator": "kaplan-meier",
    ...
    {
        "name": "B2SumDML (SurvPair & NA)",
        "kind": "python",
        "cls": B2SummaryDMLCensoredSurvivalForest,
        "surv_scalar_mode": "pair",
        "censoring_estimator": "nelson-aalen",
    },
    {
        "name": "B2SumDML (SurvPair & KM)",
        "kind": "python",
        "cls": B2SummaryDMLCensoredSurvivalForest,
        "surv_scalar_mode": "pair",
        "censoring_estimator": "kaplan-meier",
...
def parse_args():
    parser = argparse.ArgumentParser(description="Run censored structured 14-setting shortlist benchmark.")
    parser.add_argument("--setting-ids", nargs="*")
    parser.add_argument("--case-ids", nargs="*", type=int)
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=PROJECT_ROOT / "outputs" / "benchmark_structured_14settings_censored_shortlist",
    )
...
def _evaluate_candidate(case, *, spec: dict[str, object], target: str) -> dict[str, object]:
    ...
    model = spec["cls"](
        target=target,
        horizon=horizon,
        surv_scalar_mode=str(spec["surv_scalar_mode"]),
