...
MODEL_SPECS = [
    (
        "FinalNC[aug_compact|q=logit|h=extra1200x3]",
        {
            "final_feature_mode": "aug_compact",
            "q_kind": "logit",
            "h_kind": "extra",
            "h_n_estimators": 1200,
    ...
    (
        "FinalNC[aug_compact_stats|q=logit|h=extra1200x3]",
        {
            "final_feature_mode": "aug_compact_stats",
            "q_kind": "logit",
            "h_kind": "extra",
            "h_n_estimators": 1200,
            "h_min_samples_leaf": 3,
    ...
    (
        "FinalNC[summary_compact_stats|q=logit|h=extra1200x3]",
        {
            "final_feature_mode": "summary_compact_stats",
            "q_kind": "logit",
            "h_kind": "extra",
            "h_n_estimators": 1200,
            "h_min_samples_leaf": 3,
    ...
    (
        "FinalNC[aug_compact|q=poly2|h=extra400x10]",
        {
            "final_feature_mode": "aug_compact",
            "q_kind": "poly2",
            "h_kind": "extra",
    ...
    (
        "FinalNC[aug_compact_stats|q=poly2|h=extra400x10]",
        {
            "final_feature_mode": "aug_compact_stats",
            "q_kind": "poly2",
            "h_kind": "extra",
    ...
    (
        "FinalNC[aug_noq|q=logit|h=extra1200x3]",
        {
            "final_feature_mode": "aug_noq",
            "q_kind": "logit",
            "h_kind": "extra",
            "h_n_estimators": 1200,
            "h_min_samples_leaf": 3,
...
def parse_args():
    parser = argparse.ArgumentParser(description="Run basic12 non-censored single-pass finalist bracket.")
...
def main() -> int:
    ...
    for case_spec in case_specs:
        ...
        for model_index, (name, model_kwargs) in enumerate(MODEL_SPECS, start=1):
            ...
            start = time.time()
            model = _BaseSinglePassBridgeFeatureNCCausalForest(**kwargs)
