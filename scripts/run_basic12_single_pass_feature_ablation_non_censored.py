...
MODEL_ORDER = [
    ...
    "SinglePass-Augmented Full",
    "SinglePass-Augmented Compact",
    "SinglePass-Augmented Compact+Stats",
    "SinglePass-Augmented No q",
    "SinglePass-Summary Compact",
    "SinglePass-Summary Compact+Stats",
]


def parse_args():
    parser = argparse.ArgumentParser(
        description="Run basic12 non-censored ablations for single-pass internal-fold summary DML."
    )
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=PROJECT_ROOT / "non_censored" / "outputs" / "benchmark_basic12_single_pass_feature_ablation",
    )
...
def main() -> int:
    ...
    candidate_specs = [
        ...
        ("Augmented-DML + Extra h (PCI)", OldC3AugmentedDMLExtraHNCCausalForest),
        ("SinglePass-Augmented Full", SinglePassAugmentedFullNCCausalForest),
        ("SinglePass-Augmented Compact", SinglePassAugmentedCompactNCCausalForest),
        ("SinglePass-Augmented Compact+Stats", SinglePassAugmentedCompactStatsNCCausalForest),
        ("SinglePass-Augmented No q", SinglePassAugmentedNoQNCCausalForest),
        ("SinglePass-Summary Compact", SinglePassSummaryCompactNCCausalForest),
        ("SinglePass-Summary Compact+Stats", SinglePassSummaryCompactStatsNCCausalForest),
    ]
    ...
    for case_spec in selected_cases:
        ...
        for name, model_cls in candidate_specs:
