...
PYTHON="python3"
LOG_DIR="$ROOT/outputs/logs_basic12_unified_b2sum"
NONC_OUT="$ROOT/non_censored/outputs/benchmark_basic12_unified_b2sum_non_censored"
CENS_OUT="$ROOT/outputs/benchmark_basic12_unified_b2sum_censored"
NONC_RUNNER="$ROOT/scripts/run_basic12_unified_b2sum_non_censored.py"
CENS_RUNNER="$ROOT/scripts/run_basic12_unified_b2sum_censored.py"
...
def combine(output_dir: Path, time_col: str):
    parts = []
    for tag in ("q1", "q2"):
...
combine(
    Path("/Users/kyoungeuihong/Desktop/csf_grf_new/non_censored/outputs/benchmark_basic12_unified_b2sum_non_censored"),
    "time_sec",
)
combine(
    Path("/Users/kyoungeuihong/Desktop/csf_grf_new/outputs/benchmark_basic12_unified_b2sum_censored"),
    "total_time",
)
PY
