...
MODEL_SPECS = [
    ...
    ("UnifiedBroadAugSPMildShrink (Cens)", UnifiedBroadAugSPMildShrinkCensoredSurvivalForest),
]


def parse_args():
    parser = argparse.ArgumentParser(description="Run basic12 unified BroadAugSP censored benchmark.")
